...
function ItPage() {
  return (
    <EssayLayout backTo="/key" backLabel="Letter key" kicker="IT" title="The gavel that rots">
      <p>
      ...
      <p>
        ...
        CT leaks ~3%. Transfer-burn is gone; that leak is the burn. A strip should not fossilize
        last year’s regulars. IT leaks ~5% while idle. A seat that does not show up should empty
        before a year and a half. Half-life about 13.5 months at 0.95ⁿ. Hire a roomful of quiet
        holders and watch the gavel turn to dust.
      </p>
      ...
      <p>
        ...
        . IT is the weight when the case is not named yet, and when a published case needs a change.
      </p>
      <p>
