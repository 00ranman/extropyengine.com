...
export const engineViews = {
  ...
  merchant: {
    ...
    lines: [
      ...
      "Three standings, not one pile. XP is global — every closed loop that survived, leaking 0.99ⁿ. Changing how XP works is planetary. Cash-out is a lose-condition; if a room votes that in, they forked. This is not Randall’s engine. He wrote the loop. DFAOs run their rooms. CT is this community. This DFAO can vote how CT is scored inside this room. That vote does not rewrite CT next door. L is this moment at this till: this-door CT against the house slider. The slider is how much of that CT may count and how much of the ticket the layer may touch. Hand-set or optional auto from this till’s own proofs and load. Either way it writes a vertex. House can override or kill. Domain bands can feed that till as ZKPs — yes or no per instrument — shown to this door, not to the mesh. Same question as whether they close loops here. Not a second score on a forehead. A cheap or greedy slider still writes upward into that house’s own EP and the next fractal.",
...
export const engineTokens = [
  ...
  { t: "L", d: "Literal standing at this till. This-door CT against the house slider. Optional auto from this till’s proofs. Domain bands as ZKPs to this door. Not a mesh scoreboard." },
