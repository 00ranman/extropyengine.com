...
export const engineViews = {
  ...
  merchant: {
    ...
    lines: [
      ...
      "Three standings, not one pile. XP is global — every closed loop that survived, leaking 0.99ⁿ. Changing how XP works is planetary. Cash-out is a lose-condition. CT is community standing on web W: the DFAOs that still share base CT. Reputation belongs in CT (ρ_W). It does not belong in R. A DFAO posts a task worth so much CT; SignalFlow and the DAG close it. A wrap without money keeps a discounted κ. A cash-wrap drops κ to 0 and leaves the compatible web. They can still sit on the XP network. L = clip(H · κ · CT_W · β, 0, 1). H defaults to 0.5. Auto is recommended. Parking H or lying with H writes on that house’s own ledger.",
      "EP = XP × L, born and burned in the same sale. Early mesh: a penny, maybe five cents off. That is the point. It is supposed to start small. This is also employee discount and loyalty-card math without a points bag. Staff still get wages. The spark is their ticket, same as a regular the web can plan around. A punch card you farm is the lose-condition.",
...
export const engineTokens = [
  ...
  { t: "L", d: "This ticket. clip(H · κ · CT_W · β, 0, 1). H defaults to 0.5." },
