...
export const engineViews = {
  ...
  merchant: {
    ...
    lines: [
      ...
      "Three standings, not one pile. XP is global — every closed loop that survived, leaking 0.99ⁿ. Changing how XP works is planetary. Cash-out is a lose-condition; if a room votes that in, they forked. This is not Randall’s engine. He wrote the loop. DFAOs run their rooms. CT is this community. This DFAO can vote how CT is scored inside this room. That vote does not rewrite CT next door. L is this moment at this till. Literal standing right now, this ticket. CT feeds L. The house owns a public slider on L: threshold, how much of the ticket the layer may touch. That slider also writes upward into their own EP and into the next fractal’s reading of that house.",
