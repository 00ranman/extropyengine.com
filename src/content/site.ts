...
export const primaryNav: readonly NavItem[] = [
  ...
  },
  {
    ...
    href: "/math",
    children: [
      { label: "The formula", href: "/math" },
      { label: "R rarity", href: "/key#r" },
      { label: "F decay-of-repeats", href: "/key#f" },
      { label: "ΔS proxy", href: "/key#delta-s" },
      { label: "w · E", href: "/key#w-dot-e" },
      { label: "Tₛ slam", href: "/key#ts" },
