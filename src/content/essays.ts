...
export const glossarySections: { heading: string; entries: GlossaryEntry[] }[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        id: "observer-effect",
        def: "Pop-sci: I heard a spooky quantum thing I barely understood, this lyric says observation, therefore collapse, therefore the Engine is doing quantum. That chain is a rhyme, not a reading. Schrödinger wrote the cat to laugh at people who applied the quantum recipe at cat-scale. Quantum does not apply to the macro. This work does not use the observer effect. It does not claim it. A narrator who opens there invented a thesis and hung it on the author. The Lladnaros song titled Weaponized Transparency (first line: They want systems) uses “turning observation into ammunition” as watching a system and using that watching as a real lever — institutions, metrics, cameras. Not ħ. Not collapse. Ammunition in the ordinary sense.",
      },
      {
        term: "Weaponized Transparency",
        id: "weaponized-transparency",
        def: "A Lladnaros track with that exact title. First line: They want systems / I give them ecosystems. Talking about systems while fucking with them. Observation into ammunition: the watching is the lever. Macro, social, institutional. The work does not claim the observer effect. The work does not claim quantum mechanics. A show that starts there is describing its own inference, not this song.",
      },
      {
        term: "Recursion",
      ...
      },
      {
        term: "ZKP",
        id: "zkp",
        def: "Zero-knowledge proof. A circuit, not a model. Prover on the box builds a proof of one predicate (21 or not, band ≥ n, unique in this room, signer bound to this class strip). Verifier on the till checks the math. Yes or no — not the birthday, not the street, not the photo, not an LLM reading the question. A phone is only a screen talking to that box. It does not run the proof. Personal AI / SignalFlow may propose a claim. They do not evaluate the proof. DID is the name. ZKP is what you show. The class strip is not a ZKP. Circuits are not in Codex v2.1. Today: signatures.",
      },
      {
        term: "Class strip",
        id: "class-strip",
        def: "Public envelope of a vertex. Action class, mapper M_v, ΔS claimed, U, duration and feature buckets, evidence Merkle root, state, parent vertex ids. In the clear. SignalFlow scours this by class. Not DID, not GPS, not exact clock, not photo bytes. A strip too fat is an identity and does not list. Identity is a separate ZKP on the same vertex. Bytes take a LOOK.",
      },
      {
        term: "ZKP reputation",
        id: "zkp-reputation",
      ...
      },
      {
        ...
        id: "digital-autarky",
        def: "Intelligence, identity, and local context stay at the edge. The network is a handshake, a claim schema, and a DAG — not a supermind. Company login means company tether. Own hardware is how you stay unknown. The class strip is public so like-cases can exist. Edge intelligence unveils only the ZKP identity needs. Bytes take a LOOK.",
      },
      {
        term: "Not a panopticon",
        id: "not-a-panopticon",
        def: "A panopticon is one tower that sees every diary. A surveillance state is a central log you cannot opt out of. This has neither. PSLL is a file on your disk. The class strip is public. Identity is a proof — yes or no — not the file. Looking at WHO or bytes writes a vertex. Silent fetch is a detectable act. extropyengine.com is a website, not a watchtower and not a host for the Engine.",
      },
      {
        term: "DID",
        id: "did",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        term: "Late burn",
        id: "late-burn",
        def: "Same machine as late mint, the other direction. A later-revealed harm, cited, can mark the vertex BURNED and slash remaining dust plus any new delta that sat on that citation. Scope is the vertex and citation-gated children, not the whole wallet. You do not claw back what decay already ate. Ordinary remaining pile at a decade is already dust — bookkeeping, not a sword over a lawn. False late-burn can burn the accuser. A ratchet that only adds is a church.",
      },
      {
        term: "XP decay",
        id: "xp-decay",
