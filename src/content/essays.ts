  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        id: "emergent-points",
        def: "A layer on top of fiat, not a replacement and not a currency. People still spend dollars. The Engine tracks the exchange, converts it to a bits-equivalent proxy, and fine-tunes the average ΔS for that situation and those domains until the proxy is less wrong. At purchase: L is estimated from the mesh (your contribution, this shop’s local ΔS, the region, the domains in play) — a fraction, 0.something, not a coupon. EP = XP × L. No 1:1 to cash. There is no table. A vertex settles some of the exchange; how much is an agreed estimate both edges have to accept. Keep missing and the shop changes its parameters, or the customer is looking entropic. The layer exists to show why that ΔS should be worth more than the fiat-only reading. Repeat-farming is F. Cash cannot mint XP. Mom-and-pop first. ZKPs, not a KPI warehouse. Not entropy points. Not Epistemic Proof.",
      },
      {
