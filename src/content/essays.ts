...
export const glossarySections: { heading: string; entries: GlossaryEntry[] }[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        id: "observer-effect",
        def: "Pop-sci: I heard a spooky quantum thing I barely understood, this lyric says observation, therefore collapse, therefore the Engine is doing quantum. That chain is a rhyme, not a reading. Schrödinger wrote the cat to laugh at people who applied the quantum recipe at cat-scale. Quantum does not apply to the macro. This work does not use the observer effect. It does not claim it. A narrator who opens there invented a thesis and hung it on the author. The Lladnaros song titled Weaponized Transparency uses “turning observation into ammunition” as watching a system and using that watching as a real lever — institutions, metrics, cameras — while talking about the system. Not ħ. Not collapse. Not the punk-recuperation song. Ammunition in the ordinary sense.",
      },
      {
        term: "Weaponized Transparency",
        id: "weaponized-transparency",
        def: "A Lladnaros track with that exact title. Talking about systems while fucking with them. Observation into ammunition: the watching is the lever. Macro, social, institutional. Not the punk-recuperation song. Not Schrödinger’s Flex. The work does not claim the observer effect. The work does not claim quantum mechanics. A show that starts there is describing its own inference, not this song.",
      },
      {
        term: "Recursion",
