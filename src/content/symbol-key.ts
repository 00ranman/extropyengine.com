...
export const symbolKey = {
  ...
  other: [
    ...
    },
    {
      ...
      is: "Governance weight. Off the XP mint. You cannot buy it with cash or with XP. Idle leak 0.95ⁿ (~5% of remaining per ~30 days). Half-life ~13.5 months idle. Unsettled claims do not move it. A vote uses remaining IT; it does not spend it. Demonstration loops the room marked as voice-bearing mint it. Vanish and the seat empties.",
