...
export const symbolKey = {
  ...
  other: [
    ...
    },
    {
      ...
      glyph: "λ",
      name: "Local floor",
      is: "Default 0.15. EP = XP · L + λ · L. Web W publishes one number. 10-day notice to change.",
    ...
    },
    {
      ...
      is: "This till this window. Auto from this door’s signed cash. Training: remainder 0 until 10 days of signed tickets (two 5-day weeks). Then clip(0.5 × cash_in / cash_out, 0, 1). No slider. No Off on the register. Unplug is Off.",
    ...
    },
    {
      ...
      is: "Door-personal standing. Default 1 until this door has history. Fake-proof and spite cut S for 5 days (one week).",
