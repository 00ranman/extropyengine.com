...
MD = ROOT / "public/docs/LAW-SHAPED.md"
OUT = ROOT / "public/docs/Law_Shaped.pdf"
...
class Doc(FPDF):
    def header(self):
        ...
        self.cell(0, 6, "EXTROPY ENGINE  ·  LAW-SHAPED", align="L")
        self.set_text_color(*RULE)
        self.cell(0, 6, "NOT LEGAL ADVICE", align="R", new_x="LMARGIN", new_y="NEXT")
    ...
    def footer(self):
        ...
        self.set_font("Sans", "", 8)
        self.set_text_color(*MUTED)
        self.cell(0, 6, "extropyengine.com/docs/LAW-SHAPED.md", align="L")
